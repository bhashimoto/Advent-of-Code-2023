...
function day2_2(fileName) {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
        var limit, open, file, ret, _d, _e, _f, line, game, mins, e_1_1;
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 4:
                    ...
                    _d = false;
                    line = _c;
                    game = line.slice(line.indexOf(":") + 2).split(';');
                    mins = game.map(function (round) {
                        var colors = round.trim().split(',');
                        var elements = {
                            'red': 0,
                            'green': 0,
                            'blue': 0,
