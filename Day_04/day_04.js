...
function readFile(filename) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, games, _d, rl_1, rl_1_1, line, id, data, e_1_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _d = false;
                    line = _c;
                    id = parseInt(line.slice(line.indexOf(" "), line.indexOf(":")));
                ...
                case 12: return [2 /*return*/, games];
            }
        });
    });
}
function checkWins(input) {
    input.wins = input.available_numbers.map(function (num) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    games = _a.sent();
                    ret = games.map(function (game) {
                        return game.available_numbers.map(function (number) {
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    for (i = games.length - 1; i >= 0; --i) {
                        games[i].tickets = 1 + games.slice(i, i + games[i].wins + 1).reduce(function (acc, curr) {
